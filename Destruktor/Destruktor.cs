...
namespace Vsite.CSharp
{
    public class KlasaSDestruktorom
    {
        ...
        // TODO: Dodati destruktor (tj. finalizirajuću metodu) i njemu napisati naredbe koje će 
    ...
    class Destruktor
    {
        static void Main(string[] args)
        {
            ...
            // TODO: Dodati for petlju koja će se ponoviti 100000 puta i unutar koje će se 
            //kreirati novi objekti tipa KlasaSDestruktorom. Pokrenuti program i provjeriti redni 
            //broj prvog uništenog objekta.
            for(int i = 0; i < 100000; i++)
            {
                KlasaSDestruktorom k = new KlasaSDestruktorom();
            }
